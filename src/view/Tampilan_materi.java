 ...
 * @author Bayu Rs
 */
public class Tampilan_materi extends javax.swing.JFrame {

    /**
     * Creates new form Tampilan_materi
     */
    public Tampilan_materi() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tampilan_materi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tampilan_materi().setVisible(true);
            }
        });
    }
